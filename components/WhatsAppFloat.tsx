        ...
        >
          ...
          >
            ...
            <div className="relative z-10">
                {/* Official WhatsApp SVG - Increased size from 24 to 28 */}
                <svg width="28" height="28" viewBox="0 0 24 24" fill="white" xmlns="http://www.w3.org/2000/svg" className="drop-shadow-sm">
